 ...
 * 
 * Disassembly of DSDT.aml, Fri Jul 21 16:23:24 2023
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0002591A (153882)
 *     Revision         0x02
 *     Checksum         0xBD
 *     OEM ID           "HPQOEM"
 *     OEM Table ID     "1909    "
 ...
 */
DefinitionBlock ("DSDT.aml", "DSDT", 2, "HPQOEM", "1909    ", 0x00000001)
{
    /*
     * iASL Warning: There were 20 external control methods found during
     * disassembly, but only 9 were resolved (11 unresolved). Additional
    ...
    External (_SB_.PCI0.LPCB.EC__.BTST, MethodObj)    // Warning: Unresolved method, guessing 2 arguments
    External (_SB_.PCI0.LPCB.EC__.ITLB, MethodObj)    // Warning: Unresolved method, guessing 1 arguments
    External (_SB_.PCI0.PEGP.DGFX.EPON, MethodObj)    // Warning: Unresolved method, guessing 0 arguments
    ...
    External (ITLB, MethodObj)    // Warning: Unresolved method, guessing 2 arguments
    External (WMAB, MethodObj)    // Warning: Unresolved method, guessing 1 arguments
    External (XOSI, MethodObj)    // Warning: Unresolved method, guessing 1 arguments

    External (_GPE.VHOV, MethodObj)    // 3 Arguments
    External (_PR_.CPPC, FieldUnitObj)
    External (_PR_.CPU0._PPC, IntObj)
    External (_PR_.CPU0._PSS, PkgObj)
    External (_SB_.BATC, UnknownObj)
    ...
    External (_SB_.PCI0.LPCB.EC__.BTIF, IntObj)
    External (_SB_.PCI0.LPCB.EC__.GBTC, IntObj)
    External (_SB_.PCI0.LPCB.EC__.GBTI, IntObj)
    External (_SB_.PCI0.LPCB.EC__.SBTC, IntObj)
    External (_SB_.PCI0.PEGP.DGFX.DD02, UnknownObj)
    External (_SB_.PCI0.PEGP.DGFX.DIDM, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.PEGP.DGFX.OMPR, IntObj)
    External (_SB_.PCI0.PEGP.DGFX.SBRV, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.PEGP.DGFX.SVID, FieldUnitObj)
    External (_SB_.PCI0.PEGP.LNKD, FieldUnitObj)
    ...
    Method (\HPTS, 1, NotSerialized)
    {
        ...
        If (LGreater (Arg0, 0x00))
        {
            ...
            {
                Store (0x00, \_SB.PCI0.LPCB.EC.HSST)
            }
            ...
            {
                \_SB.PCI0.LPCB.EC.BTDR (0x00)
                Store (0xFF, \_SB.PCI0.LPCB.EC.NGBF)
                Store (0xFF, \_SB.PCI0.LPCB.EC.NGBT)
                Store (0x07, \_SB.PCI0.LPCB.EC.GACP)
                Store (0x01, \_SB.NFBS)
                If (LEqual (Arg0, 0x03))
                {
    ...
    Method (\HWAK, 1, NotSerialized)
    {
        ...
        \_SB.PCI0.LPCB.EC.ITLB (\_SB.PCI0.LPCB.EC.RPPC (0x01))
        If (\_SB.PCI0.LPCB.EC.ECRG)
        {
            Acquire (\_SB.PCI0.LPCB.EC.ECMX, 0xFFFF)
            Store (0x01, \_SB.PCI0.LPCB.EC.ACPI)
            Store (\WCOS (), \_SB.PCI0.LPCB.EC.OST)
            Release (\_SB.PCI0.LPCB.EC.ECMX)
        }
        ...
        Store (\_SB.PCI0.LPCB.EC.GACS (), Local2)
        \_SB.PCI0.LPCB.EC.PWUP (0x03, 0xFF)
        Store (\_SB.PCI0.LPCB.EC.GBAP (), Local1)
        Store (\_SB.PCI0.LPCB.EC.GACS (), Local3)
        ...
        If (LEqual (Arg0, 0x03))
        {
            If (CondRefOf (\_SB.ISCT))
            {
                If (And (\_SB.ISCT.ASCT, 0x01))
                {
                    ...
                    Or (\_SB.ISCT.WKRS, \_SB.PCI0.LPCB.EC.SCCS, \_SB.ISCT.WKRS) /* External reference */
                    If (And (\_SB.PCI0.IGPU.TCHE, 0x0100))
                    {
                        If (LAnd (And (\_SB.PCI0.LPCB.EC.SCCB, 0x01), LOr (And (\_SB.PCI0.LPCB.EC.SCCS, 0x02
                            ), And (\_SB.PCI0.LPCB.EC.SCCS, 0x08))))
                        {
                        ...
                        }))
                {
                    ...
                    If (LEqual (Arg2, 0x02))
                    {
                        If (LEqual (Arg1, Zero))
                        {
                            While (One)
                            {
                                Store (PEPY, _T_0) /* \_SB_.PEPD.XDSM._T_0 */
                                If (LEqual (_T_0, 0x01))
                                {
                                    Return (Package (0x02)
                                    {
    ...
    OperationRegion (GNVS, SystemMemory, 0x2DF68918, 0x019B)
    ...
    OperationRegion (ASMA, SystemMemory, 0x2DF6A018, 0x1060)
    Field (ASMA, AnyAcc, NoLock, Preserve)
    {
        ASMB,   33536
    }

    OperationRegion (AF10, SystemMemory, 0x2DF6C018, 0x10E5)
    ...
    OperationRegion (HPDF, SystemMemory, 0x2DF6EE18, 0x0182)
    ...
    OperationRegion (HPD2, SystemMemory, 0x2DE32F18, 0x006F)
    ...
    OperationRegion (HPBR, SystemMemory, 0x2DF69F18, 0x007E)
    ...
    Scope (\_GPE)
    {
        ...
        {
            Store (\_SB.GINR (0x0D), Local0)
            XOr (0x01, Local0, Local0)
            \_SB.GINW (0x0D, Local0)
            VDET ()
    ...
    0x00000001,         // Length
            ...
            Device (PEGP)
            {
                ...
                Method (XDSM, 4, Serialized)
                {
                    ...
                    While (One)
                    {
                        Store (ToInteger (Arg0), _T_0) /* \_SB_.PCI0.PEGP.XDSM._T_0 */
                                ...
                                }))
                        {
                            While (One)
                            {
                                Store (ToInteger (Arg2), _T_1) /* \_SB_.PCI0.PEGP.XDSM._T_1 */
                                If (LEqual (_T_1, 0x00))
                                {
                                    If (LEqual (Arg1, 0x02))
                                    {
                ...
                Method (XDSM, 4, Serialized)
                {
                            ...
                            }))
                    {
                        If (LEqual (Arg2, 0x00))
                        {
                            ...
                            Store (0x02, F0SS) /* \_SB_.PCI0.IGPU.XDSM.F0SS */
                ...
                Scope (DD02)
                {
                    ...
                    Method (_BCM, 1, Serialized)  // _BCM: Brightness Control Method
                    {
                        ...
                        If (Local0)
                        {
                            ...
                            Else
                            {
                                If (LEqual (\_SB.PCI0.PEGP.DGFX.SBRV (), 0x00))
                                {
                                    \_SB.SSMI (0xEA74, 0x04, Local1, 0x00, 0x00)
                                }
                            }
                                                ...
                                                Else
                                                {
                                                    ...
                                                    Else
                                                    {
                                                        ...
                                                        Else
                                                        {
                                                            If (LEqual (_T_0, 0x0A))
                                                            {
                                                                If (LEqual (\_SB.PCI0.PEGP.DGFX.VVID, 0x1002))
                                                                {
                                                                    \_SB.ODGW (0xFF01)
                                                                    \_SB.PCI0.IGPU.DGCE ()
                                                                }
            ...
            Device (PEGP.DGFX)
            {
                ...
                Method (NDOD, 0, NotSerialized)
                {
                    ...
                    {
                        Store (DIDM (), Local0)
                        Store (DerefOf (Index (Local0, 0x00)), Index (DODS, 0x00))
                        Store (0x01, DODC) /* \_SB_.PCI0.PEGP.DGFX.DODC */
                    }

                    Return (DODS) /* \_SB_.PCI0.PEGP.DGFX.DODS */
                }
                ...
                Method (XDSS, 1, Serialized)
                {
                    If (LEqual (Arg0, 0x01))
                    {
                        Store (0x05, \_SB.PCI0.LPCB.EC.TENA)
                    }
                    Else
                    {
                        Store (0x01, \_SB.PCI0.LPCB.EC.TENA)
                    }
                }
            }
            ...
            Device (EH01)
            {
                ...
                {
                    Return (UPRW) /* External reference */
                    0x0D
                    0x03
                }
                ...
                Scope (RHUB.PRT0)
                {
                    ...
                    Device (HPT0)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT0._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT0._PLD.VIS_ */
                            }
                    ...
                    Device (HPT1)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT1._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT1._PLD.VIS_ */
                            }
                    ...
                    Device (HPT2)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT2._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT2._PLD.VIS_ */
                            }
                    ...
                    Device (HPT3)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT3._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT3._PLD.VIS_ */
                            }
                    ...
                    Device (HPT4)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT4._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT4._PLD.VIS_ */
                            }
                    ...
                    Device (HPT5)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT5._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT5._PLD.VIS_ */
                            }
                    ...
                    Device (HPT6)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT6._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT6._PLD.VIS_ */
                            }
                    ...
                    Device (HPT7)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT7._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EH01.RHUB.PRT0.HPT7._PLD.VIS_ */
                            }
            ...
            Device (EH02)
            {
                ...
                Scope (RHUB.PRT0)
                {
                    ...
                    Device (HPT0)
                    {
                        ...
                        {
                            CreateBitField (DerefOf (Index (EPLD, 0x00)), 0x40, VIS)
                            If (LNot (And (VUPM, 0x0100)))
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EH02.RHUB.PRT0.HPT0._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EH02.RHUB.PRT0.HPT0._PLD.VIS_ */
                            }
                    ...
                    Device (HPT1)
                    {
                        ...
                        {
                            CreateBitField (DerefOf (Index (EPLD, 0x00)), 0x40, VIS)
                            If (LNot (And (VUPM, 0x0200)))
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EH02.RHUB.PRT0.HPT1._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EH02.RHUB.PRT0.HPT1._PLD.VIS_ */
                            }
                    ...
                    Device (HPT2)
                    {
                        ...
                        {
                            CreateBitField (DerefOf (Index (EPLD, 0x00)), 0x40, VIS)
                            If (LNot (And (VUPM, 0x0400)))
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EH02.RHUB.PRT0.HPT2._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EH02.RHUB.PRT0.HPT2._PLD.VIS_ */
                            }
                    ...
                    Device (HPT3)
                    {
                        ...
                        {
                            CreateBitField (DerefOf (Index (EPLD, 0x00)), 0x40, VIS)
                            If (LNot (And (VUPM, 0x0800)))
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EH02.RHUB.PRT0.HPT3._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EH02.RHUB.PRT0.HPT3._PLD.VIS_ */
                            }
                    ...
                    Device (HPT4)
                    {
                        ...
                        {
                            CreateBitField (DerefOf (Index (EPLD, 0x00)), 0x40, VIS)
                            If (LNot (And (VUPM, 0x1000)))
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EH02.RHUB.PRT0.HPT4._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EH02.RHUB.PRT0.HPT4._PLD.VIS_ */
                            }
                    ...
                    Device (HPT5)
                    {
                        ...
                        {
                            CreateBitField (DerefOf (Index (EPLD, 0x00)), 0x40, VIS)
                            If (LNot (And (VUPM, 0x2000)))
                            {
                                And (VIS, 0x00, VIS) /* \_SB_.PCI0.EH02.RHUB.PRT0.HPT5._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (0x01, VIS) /* \_SB_.PCI0.EH02.RHUB.PRT0.HPT5._PLD.VIS_ */
                            }
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            Name (PLDP, Package (0x01)
                            {
                                Buffer (0x10)
                                {
                                    ...
                                    /* 0008 */   0x31, 0x0C, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00
                                }
                            })
                    ...
                    Device (HS09)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            Name (PLDP, Package (0x01)
                            {
                                ...
                                {
                                    /* 0000 */   0x01, 0xC6, 0x72, 0x00, 0x00, 0x00, 0x00, 0x00,
                                    /* 0008 */   0x31, 0x0C, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00
                                }
                            })
            ...
            Scope (\_SB.PCI0.EH02.RHUB.PRT0.HPT2)
            {
                Device (WCAM)
                {
                    Name (_ADR, 0x03)  // _ADR: Address
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        Return (UPCP) /* \_SB_.PCI0.EH02.RHUB.PRT0.HPT2.WCAM._UPC.UPCP */
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        Return (PLDP) /* \_SB_.PCI0.EH02.RHUB.PRT0.HPT2.WCAM._PLD.PLDP */
                    }
                }
            }
            ...
            Device (LPCB)
            {
                ...
                Device (EC)
                {
                    ...
                    {
                        Store (\WCOS (), OST) /* \_SB_.PCI0.LPCB.EC__.OST_ */
                        PWUP (0x07, 0xFF)
                        Store (GBAP (), Local0)
                        ITLB (SBTN (Local0, 0x81))
                        PRIT ()
                    }
                    ...
                    Method (XREG, 2, NotSerialized)
                    {
                        If (LEqual (Arg0, 0x03))
                        {
                            Store (Arg1, ECRG) /* \_SB_.PCI0.LPCB.EC__.ECRG */
                    ...
                    Method (KFCL, 2, NotSerialized)
                    {
                        ...
                        If (ECRG)
                        {
                            Store (Arg1, MFAC) /* \_SB_.PCI0.LPCB.EC__.MFAC */
                            If (LAnd (LGreaterEqual (Arg0, 0x00), LLessEqual (Arg0, 0x64)))
                            {
                                Store (Arg0, CFAN) /* \_SB_.PCI0.LPCB.EC__.CFAN */
                            }
                        }
                    ...
                    Method (SFSD, 1, Serialized)
                    {
                        ...
                        Store (Local1, PWM0) /* \_SB_.PCI0.LPCB.EC__.PWM0 */
                    }
                    ...
                    Method (SSHK, 1, Serialized)
                    {
                        ...
                        {
                            Store (Arg0, Debug)
                            Store (Arg0, SHK) /* \_SB_.PCI0.LPCB.EC__.SHK_ */
                        }
                    ...
                    Method (SAST, 1, Serialized)
                    {
                        ...
                        If (ECRG)
                        {
                            Store (Arg0, AUDS) /* \_SB_.PCI0.LPCB.EC__.AUDS */
                            Store (0x01, Local0)
                        }
                    ...
                    Method (HSPW, 2, Serialized)
                    {
                        If (HSED)
                        {
                            ...
                            If (Arg0)
                            {
                                Or (Local0, Arg1, HSWK) /* \_SB_.PCI0.LPCB.EC__.HSWK */
                            }
                            Else
                            {
                                And (Local0, Not (Arg1), HSWK) /* \_SB_.PCI0.LPCB.EC__.HSWK */
                            }
                        }
                        Else
                        {
                            Store (0x00, HSWK) /* \_SB_.PCI0.LPCB.EC__.HSWK */
                        }
                    }
                    ...
                    Method (SHSW, 2, Serialized)
                    {
                        ...
                        If (ECRG)
                        {
                            If (Arg1)
                            {
                                Or (HSEN, Arg0, HSEN) /* \_SB_.PCI0.LPCB.EC__.HSEN */
                            }
                            Else
                            {
                                And (HSEN, Not (Arg0), HSEN) /* \_SB_.PCI0.LPCB.EC__.HSEN */
                            }
                        }
                    ...
                    Method (HWLP, 1, NotSerialized)
                    {
                        ...
                        If (ECRG)
                        {
                            XOr (Arg0, 0x00, WLP) /* \_SB_.PCI0.LPCB.EC__.WLP_ */
                        }
                    ...
                    Method (HWWP, 1, Serialized)
                    {
                        ...
                        If (ECRG)
                        {
                            ...
                            XOr (And (Arg0, 0x01), 0x01, WWP) /* \_SB_.PCI0.LPCB.EC__.WWP_ */
                        }
                    ...
                    Method (ECAB, 4, Serialized)
                    {
                        ...
                        {
                            Store (0xFF00, Local0)
                            Store (Arg0, ABDI) /* \_SB_.PCI0.LPCB.EC__.ABDI */
                            Store (Arg1, ABAD) /* \_SB_.PCI0.LPCB.EC__.ABAD */
                            Store (Arg2, ABIX) /* \_SB_.PCI0.LPCB.EC__.ABIX */
                            If (LEqual (And (Arg1, 0x01), 0x00))
                            {
                                Store (Arg3, ABDA) /* \_SB_.PCI0.LPCB.EC__.ABDA */
                            }

                            Store (0xFF, ABST) /* \_SB_.PCI0.LPCB.EC__.ABST */
                            Sleep (0x5A)
                            Store (0x80, Local0)
                            Store (0x0B, Local1)
                    ...
                    Method (UPAD, 0, Serialized)
                    {
                        ...
                        If (And (GACP, 0x01))
                        {
                            And (GACP, 0x06, GACP) /* \_SB_.PCI0.LPCB.EC__.GACP */
                            Release (BTMX)
                            Store (0x01, Local0)
                            Store (0x00, Local1)
                            Acquire (ECMX, 0xFFFF)
                            ...
                            Release (ECMX)
                            Store (Local0, ACST) /* \_SB_.PCI0.LPCB.EC__.ACST */
                            If (And (DTCD, 0x0800))
                            {
                                If (And (DTCD, 0x1000))
                                {
                                    Store (0x00, ACST) /* \_SB_.PCI0.LPCB.EC__.ACST */
                                }
                                Else
                                {
                                    Store (0x01, ACST) /* \_SB_.PCI0.LPCB.EC__.ACST */
                                }
                            }

                            Store (Local1, SMAR) /* \_SB_.PCI0.LPCB.EC__.SMAR */
                        }
                        Else
                        {
                            Release (BTMX)
                    ...
                    {
                        UPAD ()
                        Return (ACST) /* \_SB_.PCI0.LPCB.EC__.ACST */
                    }

                    Method (GPID, 0, Serialized)
                    {
                        UPAD ()
                        Return (SMAR) /* \_SB_.PCI0.LPCB.EC__.SMAR */
                    }
                    ...
                    Method (GBAP, 0, Serialized)
                    {
                        ...
                        If (And (GACP, 0x02))
                        {
                            And (GACP, 0x05, GACP) /* \_SB_.PCI0.LPCB.EC__.GACP */
                            Release (BTMX)
                            Acquire (ECMX, 0xFFFF)
                            If (ECRG)
                            {
                                Store (BATP, NBAP) /* \_SB_.PCI0.LPCB.EC__.NBAP */
                            }
                        ...
                        Return (NBAP) /* \_SB_.PCI0.LPCB.EC__.NBAP */
                    }
                    ...
                    Method (PWUP, 2, Serialized)
                    {
                        ...
                        Acquire (BTMX, 0xFFFF)
                        Or (Arg0, GACP, Local1)
                        And (Local1, 0x07, GACP) /* \_SB_.PCI0.LPCB.EC__.GACP */
                        If (And (GACP, 0x02))
                        {
                            Or (NGBF, Arg1, NGBF) /* \_SB_.PCI0.LPCB.EC__.NGBF */
                        }
                        ...
                        If (And (GACP, 0x04))
                        {
                            ...
                            Or (NGBT, Arg1, NGBT) /* \_SB_.PCI0.LPCB.EC__.NGBT */
                        }
                    ...
                    Method (BTDR, 1, Serialized)
                    {
                        If (LEqual (Arg0, 0x01))
                        {
                            Store (0x01, NNBO) /* \_SB_.PCI0.LPCB.EC__.NNBO */
                        }
                        Else
                        {
                            If (LEqual (Arg0, 0x00))
                            {
                                Store (0x00, NNBO) /* \_SB_.PCI0.LPCB.EC__.NNBO */
                            }
                        }

                        Return (NNBO) /* \_SB_.PCI0.LPCB.EC__.NNBO */
                    }
                    ...
                    Method (GCTL, 1, Serialized)
                    {
                        ...
                        Return (CTBF) /* \_SB_.PCI0.LPCB.EC__.GCTL.CTBF */
                    }
                    ...
                    Method (GDNM, 1, Serialized)
                    {
                        ...
                        Return (DNBF) /* \_SB_.PCI0.LPCB.EC__.GDNM.DNBF */
                    }
                    ...
                    Method (GDCH, 1, Serialized)
                    {
                        ...
                        Return (DCBF) /* \_SB_.PCI0.LPCB.EC__.GDCH.DCBF */
                    }

                    Method (BTI0, 1, Serialized)
                    {
                        ...
                        Acquire (BTMX, 0xFFFF)
                        Or (NGBT, Local7, NGBT) /* \_SB_.PCI0.LPCB.EC__.NGBT */
                        Release (BTMX)
                        Acquire (ECMX, 0xFFFF)
                        If (ECRG)
                        {
                            Store (Arg0, BSEL) /* \_SB_.PCI0.LPCB.EC__.BSEL */
                            Store (BFC, Local0)
                        ...
                        Acquire (BTMX, 0xFFFF)
                        And (NGBF, Not (Local7), NGBF) /* \_SB_.PCI0.LPCB.EC__.NGBF */
                        Release (BTMX)
                        Return (0x00)
                    }

                    Method (BTS1, 2, Serialized)
                    {
                        ShiftLeft (0x01, Arg0, Local7)
                        BTDR (0x01)
                        If (LEqual (BSTA (Local7), 0x0F))
                        ...
                        If (Arg1)
                        {
                            Store (0xFF, NGBT) /* \_SB_.PCI0.LPCB.EC__.NGBT */
                        }
                        ...
                        {
                            Acquire (BTMX, 0xFFFF)
                            Store (Local7, NDCB) /* \_SB_.PCI0.LPCB.EC__.NDCB */
                            Release (BTMX)
                        }
                        ...
                        Acquire (BTMX, 0xFFFF)
                        And (NGBT, Not (Local7), NGBT) /* \_SB_.PCI0.LPCB.EC__.NGBT */
                        Release (BTMX)
                        Return (0x00)
                    }

                    Method (ITL1, 0, NotSerialized)
                    {
                        Divide (Add (NLB1, 0x09), 0x0A, Local0, Local1)
                        Divide (Add (0x96, 0x09), 0x0A, Local0, Local2)
                        If (ECRG)
                        {
                            Store (Local1, LB1) /* \_SB_.PCI0.LPCB.EC__.LB1_ */
                            Store (Local2, LB2) /* \_SB_.PCI0.LPCB.EC__.LB2_ */
                        }
                    }

                    Method (GBT3, 1, NotSerialized)
                    {
                        ...
                        If (ECRG)
                        {
                            If (And (BATP, ShiftLeft (0x01, Arg0)))
                            {
                                ...
                                Store (Local1, BAVC) /* \_SB_.PCI0.LPCB.EC__.GBT3.BAVC */
                                Add (Local2, 0x02, Local2)
                                CreateField (DerefOf (Index (Local0, 0x02)), Multiply (Local2, 0x08), 
                                    Multiply (0x02, 0x08), RTTE)
                                Store (BRTE, RTTE) /* \_SB_.PCI0.LPCB.EC__.GBT3.RTTE */
                                Add (Local2, 0x02, Local2)
                                CreateField (DerefOf (Index (Local0, 0x02)), Multiply (Local2, 0x08), 
                                    Multiply (0x02, 0x08), ATTE)
                                Store (BATE, RTTE) /* \_SB_.PCI0.LPCB.EC__.GBT3.RTTE */
                                Add (Local2, 0x02, Local2)
                                CreateField (DerefOf (Index (Local0, 0x02)), Multiply (Local2, 0x08), 
                                    Multiply (0x02, 0x08), ATTF)
                                Store (BATF, RTTE) /* \_SB_.PCI0.LPCB.EC__.GBT3.RTTE */
                                Add (Local2, 0x02, Local2)
                                CreateField (DerefOf (Index (Local0, 0x02)), Multiply (Local2, 0x08), 
                                    Multiply (0x01, 0x08), NOBS)
                                Store (BATN, NOBS) /* \_SB_.PCI0.LPCB.EC__.GBT3.NOBS */
                            }
                            Else
                            {
                                Store (Package (0x02)
                    ...
                    Method (GBT4, 0, NotSerialized)
                    {
                        ...
                        If (ECRG)
                        {
                            ...
                            If (And (BATP, 0x01))
                            {
                                Store (0x00, BSEL) /* \_SB_.PCI0.LPCB.EC__.BSEL */
                            ...
                            If (And (BATP, 0x02))
                            {
                                Store (0x01, BSEL) /* \_SB_.PCI0.LPCB.EC__.BSEL */
                        ...
                        If (ECRG)
                        {
                            ...
                            If (LEqual (Local1, 0x00))
                            {
                                ...
                                If (And (BATP, 0x01))
                                {
                                    ...
                                    {
                                        Store (0x00, INCH) /* \_SB_.PCI0.LPCB.EC__.INCH */
                                        Store (0x00, IDIS) /* \_SB_.PCI0.LPCB.EC__.IDIS */
                                        Store (0x00, INAC) /* \_SB_.PCI0.LPCB.EC__.INAC */
                                        Store (0x00, MAXC) /* \_SB_.PCI0.LPCB.EC__.MAXC */
                                        Store (0x01, PSSB) /* \_SB_.PCI0.LPCB.EC__.PSSB */
                                        Store (Package (0x02)
                                            {
                                                0x00, 
                                                0x00
                                    ...
                                    {
                                        Store (0x00, INAC) /* \_SB_.PCI0.LPCB.EC__.INAC */
                                        Store (0x02, INCH) /* \_SB_.PCI0.LPCB.EC__.INCH */
                                        Store (0x01, IDIS) /* \_SB_.PCI0.LPCB.EC__.IDIS */
                                        Store (0x00, MAXC) /* \_SB_.PCI0.LPCB.EC__.MAXC */
                                        Store (0x00, PSSB) /* \_SB_.PCI0.LPCB.EC__.PSSB */
                                        Store (Package (0x02)
                                            {
                                                0x00, 
                                                0x00
                                    ...
                                    {
                                        Store (0x01, INAC) /* \_SB_.PCI0.LPCB.EC__.INAC */
                                        Store (0x01, INCH) /* \_SB_.PCI0.LPCB.EC__.INCH */
                                        Store (0x02, IDIS) /* \_SB_.PCI0.LPCB.EC__.IDIS */
                                        Store (0x00, PSSB) /* \_SB_.PCI0.LPCB.EC__.PSSB */
                                        Store (Package (0x02)
                                            {
                                                0x00, 
                                    ...
                                    If (LEqual (Local2, 0x03))
                                    {
                                        ...
                                        Store (0x01, IDIS) /* \_SB_.PCI0.LPCB.EC__.IDIS */
                                        Store (0x00, INAC) /* \_SB_.PCI0.LPCB.EC__.INAC */
                                        Store (0xFA, MAXC) /* \_SB_.PCI0.LPCB.EC__.MAXC */
                                        Store (0x00, PSSB) /* \_SB_.PCI0.LPCB.EC__.PSSB */
                                        Store (Package (0x02)
                                            {
                                                0x00, 
                                    ...
                                    {
                                        Store (0x00, INAC) /* \_SB_.PCI0.LPCB.EC__.INAC */
                                        Store (0x03, INCH) /* \_SB_.PCI0.LPCB.EC__.INCH */
                                        Store (Package (0x02)
                                            {
                                                0x00, 
                                                0x00
                    ...
                    {
                        Acquire (OTMT, 0xFFFF)
                        Store (GTST (), OTLL) /* \_SB_.PCI0.LPCB.EC__.OTLL */
                        Store (0x01, OTSI) /* \_SB_.PCI0.LPCB.EC__.OTSI */
                        Release (OTMT)
                    ...
                    Method (ETSI, 3, Serialized)
                    {
                        ...
                        {
                            Store (0x00, OTRT) /* \_SB_.PCI0.LPCB.EC__.OTRT */
                        }
                        ...
                        If (LOr (LNotEqual (Arg1, OTRT), LNotEqual (Arg0, OTEN)))
                        {
                            ...
                            If (ECRG)
                            {
                                ...
                                {
                                    Store (Arg1, OCPR) /* \_SB_.PCI0.LPCB.EC__.OCPR */
                                    Store (Arg1, OTRT) /* \_SB_.PCI0.LPCB.EC__.OTRT */
                                }

                                Store (Arg0, OCPE) /* \_SB_.PCI0.LPCB.EC__.OCPE */
                                Store (Arg0, OTEN) /* \_SB_.PCI0.LPCB.EC__.OTEN */
                            }
                    ...
                    Method (SMCP, 1, Serialized)
                    {
                        ...
                        If (LEqual (Arg0, 0x00))
                        {
                            Store (Local1, MXCP) /* \_SB_.PCI0.LPCB.EC__.MXCP */
                            Store (Local0, Local2)
                        }
                        Else
                        {
                            Store (Local0, MXCP) /* \_SB_.PCI0.LPCB.EC__.MXCP */
                            Store (Local1, Local2)
                        }

                        If (LEqual (LRPC, Local2))
                        {
                            Store (MXCP, LRPC) /* \_SB_.PCI0.LPCB.EC__.LRPC */
                        }
                        ...
                        If (LEqual (DCCP, 0x00))
                        {
                            Store (Local1, DCCP) /* \_SB_.PCI0.LPCB.EC__.DCCP */
                    ...
                    Method (RPPC, 1, Serialized)
                    {
                        ...
                        {
                            Store (OTLL, Local0)
                            Store (0x00, OTSI) /* \_SB_.PCI0.LPCB.EC__.OTSI */
                            If (LEqual (Local0, 0x00))
                            {
                                If (LLess (LRPC, Local1))
                                {
                                    Add (LRPC, 0x01, LRPC) /* \_SB_.PCI0.LPCB.EC__.LRPC */
                                }
                            }
                            Else
                            {
                                If (LEqual (Local0, 0x02))
                                {
                                    ...
                                    {
                                        Subtract (LRPC, 0x01, LRPC) /* \_SB_.PCI0.LPCB.EC__.LRPC */
                                    }
                                }
                                Else
                                {
                                    If (LEqual (Local0, 0x03))
                                    {
                                        Store (Local1, LRPC) /* \_SB_.PCI0.LPCB.EC__.LRPC */
                                    }
                                }
                            }
                        }
                    ...
                    Name (BUF0, ResourceTemplate()
{
    IRQNoFlags() { 0, 8, 11, 15 }
                    ...
                    Method (XCRS, 0, Serialized)
                    {
                        If (HPAE)
                        {
                            ...
                            If (LEqual (HPAS, 0x01))
                            {
                                Store (0xFED01000, HPT0) /* \_SB_.PCI0.LPCB.HPET.XCRS.HPT0 */
                            }

                            If (LEqual (HPAS, 0x02))
                            {
                                Store (0xFED02000, HPT0) /* \_SB_.PCI0.LPCB.HPET.XCRS.HPT0 */
                            }

                            If (LEqual (HPAS, 0x03))
                            {
                                Store (0xFED03000, HPT0) /* \_SB_.PCI0.LPCB.HPET.XCRS.HPT0 */
                            }
                        }
            ...
            Device (RP01)
            {
                ...
                Method (XDSM, 4, Serialized)
                {
                    ...
                    While (One)
                    {
                        Store (ToInteger (Arg0), _T_0) /* \_SB_.PCI0.RP01.XDSM._T_0 */
                        If (LEqual (_T_0, Buffer (0x10)
                                {
                                    /* 0000 */   0xD0, 0x37, 0xC9, 0xE5, 0x53, 0x35, 0x7A, 0x4D,
                                    /* 0008 */   0x91, 0x17, 0xEA, 0x4D, 0x19, 0xC3, 0x43, 0x4D
                                }))
                        {
                            While (One)
                            {
                                Store (ToInteger (Arg2), _T_1) /* \_SB_.PCI0.RP01.XDSM._T_1 */
                                If (LEqual (_T_1, 0x00))
                                {
                                    If (LEqual (Arg1, 0x02))
                                    {
                                        Store (0x01, OPTS) /* \_SB_.PCI0.RP01.OPTS */
                                        If (LTRE)
                                        {
            ...
            Device (RP02)
            {
                ...
                Method (XDSM, 4, Serialized)
                {
                    ...
                    While (One)
                    {
                        Store (ToInteger (Arg0), _T_0) /* \_SB_.PCI0.RP02.XDSM._T_0 */
                        If (LEqual (_T_0, Buffer (0x10)
                                {
                                    /* 0000 */   0xD0, 0x37, 0xC9, 0xE5, 0x53, 0x35, 0x7A, 0x4D,
                                    /* 0008 */   0x91, 0x17, 0xEA, 0x4D, 0x19, 0xC3, 0x43, 0x4D
                                }))
                        {
                            While (One)
                            {
                                Store (ToInteger (Arg2), _T_1) /* \_SB_.PCI0.RP02.XDSM._T_1 */
                                If (LEqual (_T_1, 0x00))
                                {
                                    If (LEqual (Arg1, 0x02))
                                    {
                                        Store (0x01, OPTS) /* \_SB_.PCI0.RP02.OPTS */
                                        If (LTRE)
                                        {
            ...
            Device (RP03)
            {
                ...
                Method (XDSM, 4, Serialized)
                {
                    ...
                    While (One)
                    {
                        Store (ToInteger (Arg0), _T_0) /* \_SB_.PCI0.RP03.XDSM._T_0 */
                        If (LEqual (_T_0, Buffer (0x10)
                                {
                                    /* 0000 */   0xD0, 0x37, 0xC9, 0xE5, 0x53, 0x35, 0x7A, 0x4D,
                                    /* 0008 */   0x91, 0x17, 0xEA, 0x4D, 0x19, 0xC3, 0x43, 0x4D
                                }))
                        {
                            While (One)
                            {
                                Store (ToInteger (Arg2), _T_1) /* \_SB_.PCI0.RP03.XDSM._T_1 */
                                If (LEqual (_T_1, 0x00))
                                {
                                    If (LEqual (Arg1, 0x02))
                                    {
                                        Store (0x01, OPTS) /* \_SB_.PCI0.RP03.OPTS */
                                        If (LTRE)
                                        {
            ...
            Device (RP04)
            {
                ...
                Method (XDSM, 4, Serialized)
                {
                    ...
                    While (One)
                    {
                        Store (ToInteger (Arg0), _T_0) /* \_SB_.PCI0.RP04.XDSM._T_0 */
                        If (LEqual (_T_0, Buffer (0x10)
                                {
                                    /* 0000 */   0xD0, 0x37, 0xC9, 0xE5, 0x53, 0x35, 0x7A, 0x4D,
                                    /* 0008 */   0x91, 0x17, 0xEA, 0x4D, 0x19, 0xC3, 0x43, 0x4D
                                }))
                        {
                            While (One)
                            {
                                Store (ToInteger (Arg2), _T_1) /* \_SB_.PCI0.RP04.XDSM._T_1 */
                                If (LEqual (_T_1, 0x00))
                                {
                                    If (LEqual (Arg1, 0x02))
                                    {
                                        Store (0x01, OPTS) /* \_SB_.PCI0.RP04.OPTS */
                                        If (LTRE)
                                        {
            ...
            Device (RP05)
            {
                ...
                Method (XDSM, 4, Serialized)
                {
                    ...
                    While (One)
                    {
                        Store (ToInteger (Arg0), _T_0) /* \_SB_.PCI0.RP05.XDSM._T_0 */
                        If (LEqual (_T_0, Buffer (0x10)
                                {
                                    /* 0000 */   0xD0, 0x37, 0xC9, 0xE5, 0x53, 0x35, 0x7A, 0x4D,
                                    /* 0008 */   0x91, 0x17, 0xEA, 0x4D, 0x19, 0xC3, 0x43, 0x4D
                                }))
                        {
                            While (One)
                            {
                                Store (ToInteger (Arg2), _T_1) /* \_SB_.PCI0.RP05.XDSM._T_1 */
                                If (LEqual (_T_1, 0x00))
                                {
                                    If (LEqual (Arg1, 0x02))
                                    {
                                        Store (0x01, OPTS) /* \_SB_.PCI0.RP05.OPTS */
                                        If (LTRE)
                                        {
                ...
                Device (ECF0)
                {
                    ...
                    Method (_PRW, 0, Serialized)  // _PRW: Power Resources for Wake
                    {
                        Return (^^_PRW) /* \_SB_.PCI0.RP05._PRW */
                    }
                ...
                Scope (ECF0)
                {
                    Method (_EJD, 0, NotSerialized)  // _EJD: Ejection Dependent Device
                    {
                        Return ("\\_SB.PCI0.EH01.RHUB.PRT0.HPT6")
                    }
                }
            }
            ...
            Device (RP06)
            {
                ...
                Method (XDSM, 4, Serialized)
                {
                    ...
                    While (One)
                    {
                        Store (ToInteger (Arg0), _T_0) /* \_SB_.PCI0.RP06.XDSM._T_0 */
                        If (LEqual (_T_0, Buffer (0x10)
                                {
                                    /* 0000 */   0xD0, 0x37, 0xC9, 0xE5, 0x53, 0x35, 0x7A, 0x4D,
                                    /* 0008 */   0x91, 0x17, 0xEA, 0x4D, 0x19, 0xC3, 0x43, 0x4D
                                }))
                        {
                            While (One)
                            {
                                Store (ToInteger (Arg2), _T_1) /* \_SB_.PCI0.RP06.XDSM._T_1 */
                                If (LEqual (_T_1, 0x00))
                                {
                                    If (LEqual (Arg1, 0x02))
                                    {
                                        Store (0x01, OPTS) /* \_SB_.PCI0.RP06.OPTS */
                                        If (LTRE)
                                        {
            ...
            Device (RP07)
            {
                ...
                Method (XDSM, 4, Serialized)
                {
                    ...
                    While (One)
                    {
                        Store (ToInteger (Arg0), _T_0) /* \_SB_.PCI0.RP07.XDSM._T_0 */
                        If (LEqual (_T_0, Buffer (0x10)
                                {
                                    /* 0000 */   0xD0, 0x37, 0xC9, 0xE5, 0x53, 0x35, 0x7A, 0x4D,
                                    /* 0008 */   0x91, 0x17, 0xEA, 0x4D, 0x19, 0xC3, 0x43, 0x4D
                                }))
                        {
                            While (One)
                            {
                                Store (ToInteger (Arg2), _T_1) /* \_SB_.PCI0.RP07.XDSM._T_1 */
                                If (LEqual (_T_1, 0x00))
                                {
                                    If (LEqual (Arg1, 0x02))
                                    {
                                        Store (0x01, OPTS) /* \_SB_.PCI0.RP07.OPTS */
                                        If (LTRE)
                                        {
            ...
            Device (RP08)
            {
                ...
                Method (XDSM, 4, Serialized)
                {
                    ...
                    While (One)
                    {
                        Store (ToInteger (Arg0), _T_0) /* \_SB_.PCI0.RP08.XDSM._T_0 */
                        If (LEqual (_T_0, Buffer (0x10)
                                {
                                    /* 0000 */   0xD0, 0x37, 0xC9, 0xE5, 0x53, 0x35, 0x7A, 0x4D,
                                    /* 0008 */   0x91, 0x17, 0xEA, 0x4D, 0x19, 0xC3, 0x43, 0x4D
                                }))
                        {
                            While (One)
                            {
                                Store (ToInteger (Arg2), _T_1) /* \_SB_.PCI0.RP08.XDSM._T_1 */
                                If (LEqual (_T_1, 0x00))
                                {
                                    If (LEqual (Arg1, 0x02))
                                    {
                                        Store (0x01, OPTS) /* \_SB_.PCI0.RP08.OPTS */
                                        If (LTRE)
                                        {
            ...
            Scope (HDEF)
            {
                ...
                PowerResource (APPR, 0x00, 0x0000)
                {
                    ...
                    Method (_ON, 0, NotSerialized)  // _ON_: Power On
                    {
                        ...
                        Store (\_SB.PCI0.LPCB.EC.SAST (0x01), ASTI) /* \_SB_.PCI0.HDEF.ASTI */
                    }

                    Method (_OFF, 0, NotSerialized)  // _OFF: Power Off
                    {
                        Store (0x00, ASTA) /* \_SB_.PCI0.HDEF.ASTA */
                        Store (\_SB.PCI0.LPCB.EC.SAST (0x00), ASTI) /* \_SB_.PCI0.HDEF.ASTI */
                    }
                }
            ...
            Device (ACEL)
            {
                ...
                Method (AJAL, 0, Serialized)
                {
                    If (_STA ())
                    {
                        Store (\_SB.PCI0.LPCB.EC.GACS (), Local0)
                ...
                {
                    Store (0x00, Local2)
                    If (LEqual (\_SB.PCI0.LPCB.EC.GACS (), 0x00))
                    {
                        Store (0x04, Local0)
                        Store (0x04, Local1)
                ...
                {
                    Store (\_SB.PCI0.LPCB.EC.ECAB (0x00, 0x01, Arg0, 0x00), Local0)
                    Return (Local0)
                }

                Method (ALWR, 2, Serialized)
                {
                    Store (\_SB.PCI0.LPCB.EC.ECAB (0x00, 0x00, Arg0, Arg1), Local0)
                    Return (Local0)
                }
	...
	Zero,
        ...
        {
            Store (\_SB.PCI0.LPCB.EC.BTIF, Arg0)
            Local0
        ...
        Method (BTST, 1, Serialized)
        {
            ...
            Store (\_SB.PCI0.LPCB.EC.BTST (Arg0, Local1), Local0)
        ...
        Device (BAT0)
        {
            ...
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Store (\_SB.PCI0.LPCB.EC.BSTA (0x01), Local0)
                If (XOr (BT0P, Local0))
                {
        ...
        Device (ADP1)
        {
            ...
            Method (_PSR, 0, NotSerialized)  // _PSR: Power Source
            {
                Store (\_SB.PCI0.LPCB.EC.GACS (), Local0)
                Store (Local0, PWRS) /* \PWRS */
                Store (\_SB.PCI0.LPCB.EC.GPID (), Local1)
                If (XOr (Local0, ACST))
                {
                    \_GPE.HNLP (0x00)
                    \_SB.PCI0.ACEL.AJAL ()
        ...
        Device (LID)
        {
            ...
            {
                Store (\_SB.PCI0.LPCB.EC.CLID, Local0)
                Return (Local0)
            }
        }
        ...
        Scope (\_SB.PCI0.RP01)
        {
            OperationRegion (TBTC, PCI_Config, 0x19, 0x02)
            Field (TBTC, ByteAcc, NoLock, Preserve)
            {
                TBUS,   8
            }
        ...
        Scope (\_GPE)
        {
            Method (OSUP, 1, NotSerialized)
            {
                ...
                Store (0x00, P2TB) /* \_GPE.OSUP.P2TB */
                Return (0x01)
            }

            Method (MMTB, 0, NotSerialized)
            {
                Store (\_SB.PCI0.RP01.TBUS, Local0)
                ShiftLeft (Local0, 0x14, Local0)
                Add (0xE0000000, Local0, Local1)
                Return (Local1)
            }
            ...
            Method (_E1E, 0, NotSerialized)  // _Exx: Edge-Triggered GPE
            {
                Sleep (0x96)
                Store (TBFF (), Local0)
                If (LEqual (Local0, 0x01))
        ...
        Scope (\)
        {
            Method (TWAK, 0, NotSerialized)
            {
                ...
                If (LNotEqual (\_SB.PCI0.RP01.D3HT, 0x00))
                {
                    Store (0x00, \_SB.PCI0.RP01.D3HT)
                }
        ...
        Device (HST1)
        {
            ...
            Method (_PSW, 1, NotSerialized)  // _PSW: Power State Wake
            {
                \_SB.PCI0.LPCB.EC.HSPW (Arg0, 0x01)
            }
    ...
    {
        Store (\_SB.PCI0.LPCB.EC.KRFS (), Local0)
        Return (Local0)
    }
    ...
    Method (\_SB.GLVW, 2, Serialized)
    {
        If (LLess (Arg0, 0x20))
        {
            ...
            And (GPL0, Not (Local1), Local2)
            Or (Local2, Local0, GPL0) /* \GPL0 */
        }
        Else
        {
            If (LLess (Arg0, 0x40))
            {
                ...
                And (GPL2, Not (Local1), Local2)
                Or (Local2, Local0, GPL2) /* \GPL2 */
            }
            Else
            {
                ShiftLeft (Arg1, Subtract (Arg0, 0x40), Local0)
                ShiftLeft (0x01, Subtract (Arg0, 0x40), Local1)
                And (GPL3, Not (Local1), Local2)
                Or (Local2, Local0, GPL3) /* \GPL3 */
            }
        }
    ...
    Method (\_SB.GISW, 2, Serialized)
    {
        If (LLess (Arg0, 0x20))
        {
            ShiftLeft (Arg1, Arg0, Local0)
            ShiftLeft (0x01, Arg0, Local1)
            And (GPSL, Not (Local1), Local2)
            Or (Local2, Local0, GPSL) /* \GPSL */
        }
        Else
        {
            If (LLess (Arg0, 0x40))
            {
                ShiftLeft (Arg1, Subtract (Arg0, 0x20), Local0)
                ShiftLeft (0x01, Subtract (Arg0, 0x20), Local1)
                And (GPS2, Not (Local1), Local2)
                Or (Local2, Local0, GPS2) /* \GPS2 */
            }
            Else
            {
                ShiftLeft (Arg1, Subtract (Arg0, 0x40), Local0)
                ShiftLeft (0x01, Subtract (Arg0, 0x40), Local1)
                And (GPS3, Not (Local1), Local2)
                Or (Local2, Local0, GPS3) /* \GPS3 */
            }
        }
    ...
    Method (\_SB.GINW, 2, Serialized)
    {
        If (LLessEqual (Arg0, 0x0F))
        {
            ShiftLeft (Arg1, Arg0, Local0)
            ShiftLeft (0x01, Arg0, Local1)
            And (GIV, Not (Local1), Local2)
            Or (Local2, Local0, GIV) /* \GIV_ */
        }
    }
    ...
    Method (PWAK, 1, Serialized)
    {
        ...
        {
            Store (0x02, \_SB.PCI0.PEGP.DGFX.OMPR) /* External reference */
        }
